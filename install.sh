...
yaourt -S i3 conky powerline-fonts-git rxvt-unicode mpd ncmpcpp mpc dmenu nm-applet vim mpv-git tmux zsh mpc screenfetch speedtest-cli scrot  xfce4-screenshooter python2-potr youtube-dl firefox zsh-syntax-highlighting
